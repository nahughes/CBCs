...
#EXTENSION UNIT A2
""" #Population Inference w/ GW Data """
#! pip install -q gwpopulation==0.10.0 nestle==0.2.0

""" #A Heirarchy of Bayesian Inference """
#go over unit w/ Dr. hughes
...
#end of unit, go over end notes together